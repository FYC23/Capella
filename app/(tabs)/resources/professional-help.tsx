    ...
    <SafeAreaView style={styles.container} edges={['top', 'left', 'right']}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <ThemedText type="title" style={styles.headerTitle}>{t('resources.professionalHelp.title')}</ThemedText>
          <View style={styles.placeholder} />
        </View>

        <ThemedView style={styles.section}>
          <ThemedText type="subtitle" style={styles.sectionTitle}>{t('resources.professionalHelp.overview')}</ThemedText>
          <TouchableOpacity style={styles.linkButton} onPress={() => openLink('https://wanchunghuang.com/stuttering-theory-practice-2')}>
            <IconSymbol name="text.quote" size={20} color="#D1D1D6" />
            <ThemedText style={styles.linkText}>{t('resources.professionalHelp.link1')}</ThemedText>
            <IconSymbol name="chevron.right" size={16} color="#C7C7CC" />
          </TouchableOpacity>
          <TouchableOpacity style={styles.linkButton} onPress={() => openLink('https://www.tcda.org.tw/2919')}>
            <IconSymbol name="text.quote" size={20} color="#D1D1D6" />
            <ThemedText style={styles.linkText}>{t('resources.professionalHelp.link2')}</ThemedText>
            <IconSymbol name="chevron.right" size={16} color="#C7C7CC" />
          </TouchableOpacity>
        </ThemedView>
      </ScrollView>
...
/* styles: identical to previous files — keep existing styles */
